...
else
{
    ...
    {
        $content=___codepre(___convert($data,"UTF-8",$charset));
    }
    echo "<div class=\"like\">爱特文本编辑工具</div>\n";
    echo "<div class=\"love\">\n";
    echo "<form action=\"?path=".urlencode($path)."\" method=\"POST\">\n";
    ...
    echo "<textarea name=\"content\" style=\"width:98%;height:400px;\">$content</textarea>\n<br/>\n";
    echo "</form>\n";
    echo "</div>\n";
    xhtml_footer();
}
