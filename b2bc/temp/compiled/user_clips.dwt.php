...
margin: 10px 0 15px;">
  ...
  <div class="content_body2 " style="color:#666;">
      ...
      <div class="memInfo">
        ...
        <span class=" weiruan f_l" style="font-size:19px; color:#345;padding: 0 5px 0 0;"><?php echo $this->_var['info']['username']; ?> </span>
          ...
          <?php echo $this->_var['lang']['not_validated']; ?> <a href="javascript:sendHashMail()"  class="pink "><?php echo $this->_var['lang']['resend_hash_mail']; ?></a><br />
           <?php endif; ?>
             ...
             <div class="blank"></div>
                <div class="blank"></div>
           <div  class="infoTip" >
           <span class="bold"><img src="themes/wanbiao/images/infoTip.jpg" border="0"></span>&nbsp;<?php echo $this->_var['user_notice']; ?>
           </div>
          ...
          <form action="user.php" method="post" enctype="multipart/form-data" name="formMsg" onSubmit="return submitMsg()">
                  <table width="100%" border="0" cellpadding="3">
                    ...
                    <tr>
                      ...
                      <td>
                      <a href ="<?php echo $this->_var['order_info']['url']; ?>"><img src="themes/wanbiao/images/note.gif" /><?php echo $this->_var['order_info']['order_sn']; ?></a>
...
?>
    <a href="search.php?keywords=<?php echo urlencode($this->_var['tag']['tag_words']); ?>" class="f6"><?php echo htmlspecialchars($this->_var['tag']['tag_words']); ?></a> <a href="user.php?act=act_del_tag&amp;tag_words=<?php echo urlencode($this->_var['tag']['tag_words']); ?>" onclick="if (!confirm('<?php echo $this->_var['lang']['confirm_drop_tag']; ?>')) return false;" title="<?php echo $this->_var['lang']['drop']; ?>"><img src="themes/wanbiao/images/drop.gif" alt="<?php echo $this->_var['lang']['drop']; ?>" /></a>&nbsp;&nbsp;
    <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
    <?php else: ?>
